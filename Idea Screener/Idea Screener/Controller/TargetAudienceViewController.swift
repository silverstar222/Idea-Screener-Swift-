//
//  TargetAudienceViewController.swift
//  Idea Screener
//
...
class TargetAudienceViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let genderData = ["Male","Female","Include All"]
    let ageData = ["18-24","25-30","31-40","41-60","61 and older","Include All"]
    let incomeData = ["Below $30k","Between $30k and $45k","Between $44k and $75k","Between $76k and $100k","Above $100k","Include All"]
    let educationData = ["Did not complete High School","High School","College","Advanced Degree","Include All"]
    let lifestyleData = ["Urban","Rural","Suburban","Include All"]
    let relationshipData = ["Single","Married","Include All"]
    let lifeStageData = ["Has kids in the home","No Kids in the home","Include All"]
    let ownershipData = ["Own a home","Don’t own a home","Include All"]
    ...
    @IBAction func nextBtnTap(_ sender: UIButton) {
        ...
        optionData.targetAudience = dataToPass
        
        performSegue(withIdentifier: "GotoConfirmationSegue", sender: optionData)
    }
        ...
        if segue.identifier == "GotoConfirmationSegue" {
            if let confirmationViewController = segue.destination as? ConfirmationViewController {
                if let dataToPass = sender as? OptionData {
                    confirmationViewController.optionData = dataToPass
                }
            }
        }
    }
